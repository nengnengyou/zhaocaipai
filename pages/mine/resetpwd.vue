	...
	<view>
		<form>
			<view class="cu-form-group margin-top">
				...
				<input v-if="from == 'user'" placeholder="请输入手机号" name="input" v-model="param.mobile" disabled="false"></input>
			...
			<view class="cu-form-group">
				...
				<button class='cu-btn bg-blue shadow' :class="codeTipsColor[getCodeStatus]" @tap="getCode">{{codeTips[getCodeStatus]}}</button>
			</view>
		</form>
